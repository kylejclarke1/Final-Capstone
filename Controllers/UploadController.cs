...
namespace FinalCapstone.Controllers
{
    public class UploadController : Controller
    {
        ...
        public IActionResult Index(string name, string id)
        {
            ...
            return RedirectToAction("userImages","Home");
        }
        ...
        public ActionResult UserImages()
        {
            ...
            {
                Images = Directory.EnumerateFiles(Path.Combine(_environment.WebRootPath, "~/userImages"))
                                  .Select(fn => "~/userImages" + Path.GetFileName(fn))
            };
            return View(model);
        }
    }
